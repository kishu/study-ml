...
# define training data - frist of 70% 
...
# define the variables holding the size_factor and pirce we set during training.
...
# notice, the use of the tensorflow add and muliply functions
# these add the operations to the computation graph,
# and the tensorflow methods understand how to deal with TensorFlow
# therefore do not try to use numpu or ohter library methods
...
# optimizer learnint rate. the size of the steps down the gradient
learning_rate = 0.1

# 4. define a gradient descent optimizer that will minimize the loss defined in the operation
...
with tf.Session() as sess:
    ...
    # set how often displzy training progress and number of training iterations
    # display_every = 2
    num_training_iter = 50

    # keep iterationg the training data
